...
<div  style="height:100%;">
  <ul id="navigation">
    <li> <a class="head">文章管理</a>
      <ul>
        <li><a href="ArticleServlet" target="rightFrame">查询文章</a></li> 
        <li><a href="ArticleServlet?method=addInput" target="rightFrame">添加文章</a></li>
        <li><a href="CommentAdminServlet" target="rightFrame">留言管理</a></li>
      </ul>
    </li>
    <li> <a class="head">频道管理</a>
      <ul>
        <li><a href="ChannelServlet" target="rightFrame">查询频道</a></li>
