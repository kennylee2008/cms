...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
  	<td>
  		<form action="SearchArticlesServlet" method="get">
  ...
  <tr>
    <td height="30">
<pg:pager url="SearchArticlesServlet" items="${total}" maxPageItems="${pagesize}" maxIndexPages="15" export="currentPageNumber=pageNumber">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
